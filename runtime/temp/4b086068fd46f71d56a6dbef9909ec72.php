<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\server\PHPTutorial\WWW\seat/application/admin\view\driver\add.html";i:1545553812;s:72:"D:\server\PHPTutorial\WWW\seat\application\admin\view\layout\header.html";i:1545486235;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<blockquote class="layui-elem-quote layui-text">
    <a class="xhx AA094" href="<?php echo url('driver/index'); ?>">驾校管理</a>&nbsp>&nbsp添加驾校
</blockquote>
<style>
...
<form class="layui-form" action="<?php echo url('driver/addAction'); ?>" method="post">
    ...
    <?php if(is_array($rolelist) || $rolelist instanceof \think\Collection || $rolelist instanceof \think\Paginator): $i = 0; $__LIST__ = $rolelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="price[<?php echo $vo['id']; ?>]" autocomplete="off" placeholder="请输入<?php echo $vo['name']; ?>看到的价格" class="layui-input inputWidth">
            </div>
        </div>
    ...
    layui.use(['form', 'layedit', 'laydate'], function(){
        ...
        form.on('submit(demo1)', function(data){
            layui.use('jquery',function(){
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo url('driver/addAction'); ?>", // ajax请求路径
                    data: data.field,
